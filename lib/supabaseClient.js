...
console.log('🔍 DOMIVA DEBUG - Environment check:', {
  hasUrl: !!supabaseUrl,
...
if (supabaseUrl && supabaseAnonKey) {
  try {
    ...
    console.log('✅ DOMIVA DEBUG - Supabase client created successfully')
  } catch (error) {
    console.warn('❌ DOMIVA DEBUG - Supabase client creation failed:', error)
  }
} else {
  console.warn('⚠️ DOMIVA DEBUG - Missing environment variables, using mock data')
}
