...
// Simple mock storage
const mockStorage = {
  users: typeof window !== 'undefined' ? JSON.parse(localStorage.getItem('domiva_users') || '[]') : [],
  currentUser: typeof window !== 'undefined' ? JSON.parse(localStorage.getItem('domiva_current_user') || 'null') : null,
